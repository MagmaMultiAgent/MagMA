...
class ObservationParser():
    ...
    def get_map_features(self, player: str, obs: lux.kit.GameState, env_cfg: EnvConfig):
    ...
    def get_action_features(self, obs: lux.kit.GameState, env_cfg: EnvConfig):
    ...
    def get_global_features(self, obs: lux.kit.GameState, player: str, env_cfg: EnvConfig, map_feature: np.ndarray):
