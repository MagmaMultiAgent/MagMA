...
```bash
python train.py --n-envs 10 --log-path ../results/<date>_<model>_<run_num> --seed 999
```
...
```bash
python train.py --n-envs 10 --log-path ../results/<date>_<model>_<run_num> --model-path ../results/<date>_<model>_<run_num>/models/best_model --eval --seed 999
```
