...
\noindent We have also used AI tools like \textbdd{GitHub CoPilot} (\textcolor{deepblue}{\cite{github-copilot}}) to speed up development, \textbdd{Grammarly} (\textcolor{deepblue}{\cite{Grammarly}}) for grammar checking, and \textbdd{ChatGPT} (\textcolor{deepblue}{\cite{chatgpt}}) to help with phrasing.
